...
<?php
     ...
     include_once ('Includes/header.php');
	  $pid =  substr($_REQUEST['pid'], 10, -10);
         
     ?>
<div id="column-right" style="display:block;">
  <div id="story-box" class="white-background">
    <div id="p-title-box" class="title-box-background-orange title-medium">Add reports </div>
    ...
    <form method="POST" action="" enctype="multipart/form-data" name="report_frm_<?php echo $i;?>">
      ...
      <tr id="reportmn">
        <td style ="width:200px;"><input type="file" name="reportm[]" id="reportm[]" required/>
          <!--<a href="javascript:void(o);" id="addnewaddress" name="addnewaddress" class="btn" onClick="addDiv('newaddDIV_<?php echo $i;?>');"><img src="Images/plus.png" title="Add More Reports"></a></td>-->
      ...
      <tr>
        ...
        <input type="hidden" name="patient_id" value="<?php echo ($_SESSION['Patient_id']!= '')?$_SESSION['Patient_id']:''; ?>"/>
      <tr>
        <td>
            <input id="button_<?php echo $i;?>" type="submit" name="reports_<?php echo $i;?>" value="upload">
        </td>
      </tr> </form>
      <?php $i++;} ?>
